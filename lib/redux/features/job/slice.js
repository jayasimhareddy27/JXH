...
const jobSlice = createSlice({
  ...
  reducers: {
    hydrateJobs: (state, action) => {
      // Use logical OR to prevent overwriting with undefined if key is missing in cache
      state.trackerListing = action.payload.trackerListing || state.trackerListing;
      state.marketListing = action.payload.marketListing || state.marketListing;
...
export const { setSearchFilter, clearCurrentJob,hydrateJobs } = jobSlice.actions;
