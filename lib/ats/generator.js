...
/**
 * Analyzes a resume against a job description and returns ATS scores
 * using pure string/keyword matching — no AI call.
 *
 * @param {Object} formDataMap - The resume form data map
 * @param {Object} displayJob  - The job object (must have rawDescription)
 * @returns {{
 *   overallScore: number,
 *   sections: {
 *     keywordMatch:    { score: number, matched: string[], missing: string[] },
 *     skillsAlignment: { score: number, matched: string[], missing: string[] },
 *     experienceMatch: { score: number, notes: string },
 *     formatScore:     { score: number, notes: string },
 *   },
 *   suggestions: string[],
 * }}
 */
